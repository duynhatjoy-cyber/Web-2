...
<header class="booking-header"><div class="booking-shell header-inner"><a class="booking-logo" href="${homeUrl}">${mark}<span><strong>Lif<em>rooms</em></strong><small>Your Trusted Partner</small></span></a><nav class="booking-steps" aria-label="Các bước đặt phòng"><span class="active"><b>1</b> Chọn phòng</span><i></i><span id="step-info"><b>2</b> Thông tin khách</span><i></i><span id="step-done"><b>3</b> Xác nhận</span></nav><a class="back-link" href="${homeUrl}">← Về trang chủ</a></div></header>
<main class="booking-main booking-shell">
  <div class="booking-breadcrumb"><a href="${homeUrl}">Trang chủ</a><span>›</span><span>Đặt phòng</span></div>
...
<footer class="booking-footer"><div class="booking-shell"><span>© 2026 Lifrooms · Your Trusted Partner</span><a href="${homeUrl}">Về trang chủ ↗</a></div></footer>`
